...
const services = [
  {
    ...
    desc: 'Scalable APIs, microservices & cloud infrastructure',
  ...
  },
  {
    ...
    desc: 'Research-driven design that converts',
    href: '/services/design'
  },
  {
    title: 'AI Automation',
    desc: 'Intelligent workflows & machine learning solutions',
    href: '/services/ai'
  },
  {
    title: 'SaaS Products',
    desc: 'End-to-end SaaS product engineering',
    href: '/services/saas'
  },
  {
    title: 'Ecommerce',
    desc: 'High-performance online stores & marketplaces',
    href: '/services/ecommerce'
  },
  {
    title: 'CRM Solutions',
    desc: 'Custom CRM systems tailored to your business',
    href: '/services/crm'
  }
]
...
const whoWeServe = [
  {
    title: 'Industries',
    desc: 'Fintech, Healthcare, Ecommerce & more',
    href: '/industries'
  },
  {
    title: 'Work Portfolio',
    desc: 'Explore our categorized project showcase',
    href: '/work'
  }
]
...
const company = [
  ...
  {
    title: 'Blog',
    desc: 'Insights, guides & industry perspectives',
    href: '/blog'
  },
  {
    title: 'Process',
    desc: 'How we deliver exceptional results',
    href: '/process'
  },
      ...
      <div className='container-wide section-padding'>
        <nav className='flex items-center justify-between h-18 py-4'>
          ...
          <Link href='/' className='flex items-center gap-2.5 group'>
            <div
              className='w-9 h-9 rounded-xl bg-gray-300
 flex items-center justify-center overflow-hidden group-hover:shadow-lg transition-all duration-300'
            >
              <Image
                src='/commit4solutions-log1.png'
                alt='Commit4Solutions logo'
                width={24}
                height={24}
                    ...
                    >
                      ...
                      >
                        {getDropdownItems(item.dropdown).map(sub => (
                          ...
                          >
                            <span className='text-sm font-body font-semibold text-foreground group-hover:text-accent transition-colors'>
                              {sub.title}
                            </span>
