...
const reasons = [
  {
    ...
    desc: 'We start with business goals, not just code. Every decision is purpose-driven.'
  },
  {
    icon: MessageSquare,
    title: 'Fast Communication',
    desc: 'Dedicated teams, async-first culture, and 24-hour response guarantee.'
  },
  {
    icon: TrendingUp,
    title: 'Scalable Engineering',
    desc: 'Architecture built for growth — from MVP to millions of users.'
  },
  {
    icon: Layers,
    title: 'Design + Dev Synergy',
    desc: 'Designers and engineers work side by side for pixel-perfect execution.'
  },
  {
    icon: Eye,
    title: 'Business-First Approach',
    desc: 'We measure success by your metrics — conversions, retention, revenue.'
  },
  {
    icon: ShieldCheck,
    title: 'Quality Assurance',
    desc: 'Rigorous testing, code reviews, and automated CI/CD pipelines.'
  },
  {
    icon: Clock,
    title: 'Reliable Delivery',
    desc: 'We ship on time. No excuses, no delays, no scope surprises.'
  },
  {
    icon: Zap,
    title: 'Transparent Process',
    desc: 'Weekly sprints, real-time dashboards, and full visibility into progress.'
  }
]
        ...
        <div className='grid sm:grid-cols-2 lg:grid-cols-4 gap-5'>
          {reasons.map((r, i) => (
            <AnimatedSection key={r.title} delay={i * 0.06}>
              <div
                className={`group relative overflow-hidden rounded-2xl border border-border/50 p-6 hover:shadow-lg hover:-translate-y-1 transition-all duration-500 ${
              ...
              >
                ...
                <div className='relative z-10'>
                  ...
                  <h3 className='font-heading font-semibold text-sm mb-2 group-hover:text-accent transition-colors duration-300'>
                    {r.title}
                  </h3>
