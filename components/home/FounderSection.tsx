        ...
        <div className='grid lg:grid-cols-2 gap-12 lg:gap-20 items-center'>
          ...
          <AnimatedSection delay={0.15}>
            ...
            <blockquote className='text-xl sm:text-2xl font-heading font-medium leading-relaxed mb-6 text-foreground'>
              &ldquo;We built NexaBuild because we were tired of seeing great
              ideas fail due to poor execution. Every product deserves
              engineering that matches its ambition.&rdquo;
            </blockquote>
            <p className='text-sm font-body text-muted-foreground leading-relaxed mb-6'>
              Our philosophy is simple: treat every project like a startup we
              co-founded. We invest the same care, urgency, and strategic
              thinking that founders bring to their own products. That&apos;s
              why 98% of our clients stay with us beyond the first project.
            </p>
