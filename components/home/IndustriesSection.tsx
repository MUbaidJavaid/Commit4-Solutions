...
import { Building2, Heart, ShoppingBag, GraduationCap, Home, Truck, UtensilsCrossed, Cloud, Cpu, Building } from "lucide-react";
...
const industries = [
  { icon: Building2, name: "Fintech", desc: "Banking, payments, and financial platforms" },
  { icon: Heart, name: "Healthcare", desc: "Telehealth, EHR, and patient platforms" },
  { icon: ShoppingBag, name: "Ecommerce", desc: "Marketplaces and D2C commerce" },
  { icon: GraduationCap, name: "Education", desc: "EdTech and learning management" },
  ...
  { icon: UtensilsCrossed, name: "Food & Grocery", desc: "Delivery and restaurant tech" },
  { icon: Cloud, name: "SaaS", desc: "B2B and enterprise software" },
  { icon: Cpu, name: "AI Startups", desc: "ML platforms and AI tools" },
  { icon: Building, name: "Enterprise", desc: "Large-scale digital transformation" },
];
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start gap-6 mb-16">
            <div>
              ...
              <p className="text-base font-body text-muted-foreground max-w-lg">
                We've delivered mission-critical software across sectors that demand precision, compliance, and scale.
              </p>
            </div>
            <Link href="/industries" className="btn-outline text-xs shrink-0 mt-2">
              Explore Industries
            </Link>
          </div>
        </AnimatedSection>
            ...
            <AnimatedSection key={ind.name} delay={i * 0.05}>
              ...
              >
                ...
                <div className="relative">
                  ...
                  <h3 className="text-sm font-heading font-semibold text-foreground mb-1">{ind.name}</h3>
                  <p className="text-[11px] font-body text-muted-foreground leading-relaxed opacity-0 group-hover:opacity-100 transition-opacity duration-300">{ind.desc}</p>
                </div>
              </Link>
            </AnimatedSection>
          ))}
