          ...
          <div className='bg-primary text-primary-foreground rounded-[2rem] p-10 sm:p-16 lg:p-20 relative overflow-hidden'>
            ...
            <div className='relative text-center max-w-2xl mx-auto'>
              ...
              <p className='text-base font-body text-primary-foreground/60 max-w-lg mx-auto mb-8 leading-relaxed'>
                ...
                hours with a strategic roadmap and honest estimate.
              </p>
              <div className='flex flex-wrap items-center justify-center gap-4'>
                ...
                <Link
                  href='/work'
                  className='inline-flex items-center gap-2 px-7 py-3.5 border-2 border-primary-foreground/20 text-primary-foreground font-body font-semibold text-sm rounded-full hover:border-primary-foreground/50 hover:bg-primary-foreground/5 transition-all duration-300'
                >
                  View Case Studies
                </Link>
              </div>
