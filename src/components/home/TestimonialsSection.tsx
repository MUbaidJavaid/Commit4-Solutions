...
const testimonials = [
  {
    quote: "NexaBuild didn't just build our platform — they became a strategic partner. The quality of engineering and speed of delivery exceeded every expectation.",
    name: "Jennifer Lucas",
  ...
  {
    quote: "Their team integrated seamlessly with ours. Fast communication, clean code, and they genuinely cared about our business outcomes, not just shipping features.",
    name: "David Kim",
  ...
  {
    quote: "We went from concept to a fully launched SaaS product in 14 weeks. The design quality and technical depth were world-class.",
    name: "Sarah Okafor",
                ...
                <div className="border-t border-border/50 pt-5">
                  <div className="flex items-center gap-3">
                    <div className="w-11 h-11 rounded-full bg-accent/15 flex items-center justify-center">
                      <span className="text-xs font-heading font-bold text-accent">{t.avatar}</span>
                    </div>
                    <div>
